...
import retina.db.SuggestionManager;

public class BotEventHandler implements ConnectionEventListener {
	
	private CompilationErrorEventManager dbmanager = new CompilationErrorEventManager();
	private SuggestionManager smanager = new SuggestionManager();
	private MessageSender sender;
	
	// maps IM handles to RetinaServer usernames
        ...
        try {
            ...
            else if (line.startsWith("login"))
            {
            	...
            	if (name != null)
            	{
            		...
            		name = name.split(" ")[0];
            		reply = "Hello, " + name + ", welcome to RetinaServer Help.";
            	}
            	else
            	{
